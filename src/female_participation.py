...
# Analise 1: Participacao dos atletas do brasil (df1, df3 e df4) comparado com o mundo (agrupado por ano)
...
df_paralymp_countries = pd.merge(
        df_paralymp_countries,
        df_aux,
        how='outer',
        on=['Year', 'NOC']
    )
